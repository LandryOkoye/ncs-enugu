          ...
          >
            <div className="space-y-8 relative z-10">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <motion.a href="https://instagram.com/ncsenugu" target="_blank" className="flex items-center gap-4 group p-4 rounded-xl bg-[#efe5d2]/5 border border-[#efe5d2]/10 hover:border-[#c59d5f]/50 transition-all duration-300 hover:bg-[#efe5d2]/10" whileHover={prefersReducedMotion ? undefined : { x: 6, scale: 1.02 }} whileTap={{ scale: 0.98 }} transition={{ type: "spring", stiffness: 320, damping: 22 }}>
                  <div className="w-12 h-12 rounded-full bg-black/30 flex items-center justify-center shrink-0 group-hover:bg-[#c59d5f] transition-colors duration-300">
                ...
                <motion.a href="https://www.x.com/ncsenugu" target="_blank" className="flex items-center gap-4 group p-4 rounded-xl bg-[#efe5d2]/5 border border-[#efe5d2]/10 hover:border-[#c59d5f]/50 transition-all duration-300 hover:bg-[#efe5d2]/10" whileHover={prefersReducedMotion ? undefined : { x: 6, scale: 1.02 }} whileTap={{ scale: 0.98 }} transition={{ type: "spring", stiffness: 320, damping: 22 }}>
                  <div className="w-12 h-12 rounded-full bg-black/30 flex items-center justify-center shrink-0 group-hover:bg-[#c59d5f] transition-colors duration-300">
